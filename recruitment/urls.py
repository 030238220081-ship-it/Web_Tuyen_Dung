...
urlpatterns = [
    ...
    path('templates/', views.manage_templates_view, name='manage_templates'),
    path('api/analyze-cv-job/', views.analyze_cv_for_job_api, name='analyze_cv_for_job_api'),
    path('all-applicants/', views.all_applicants_view, name='all_applicants'),
    path('application/<int:application_id>/detail/', views.application_detail_view, name='application_detail'),
]
